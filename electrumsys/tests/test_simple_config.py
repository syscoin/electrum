...
class Test_SimpleConfig(ElectrumSysTestCase):
    ...
    def setUp(self):
        ...
        self.options = {"electrumsys_path": self.electrumsys_dir}
    ...
    def tearDown(self):
        ...
        shutil.rmtree(self.electrumsys_dir)
...
class TestUserConfig(ElectrumSysTestCase):
